...
GST_DEBUG_CATEGORY (dynappsrc_playbin_debug);
#define GST_CAT_DEFAULT dynappsrc_playbin_debug
...
main (int argc, char *argv[])
{
  ...
  GST_DEBUG_CATEGORY_INIT (dynappsrc_playbin_debug, "dynappsrc-playbin", 0,
      "dynappsrc playbin example");
  ...
  g_assert (playbin);
  video_app->playbin = playbin;
  audio_app->playbin = playbin;
  ...
  g_object_set (playbin, "uri", "dynappsrc://", NULL);
